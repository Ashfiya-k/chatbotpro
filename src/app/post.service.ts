...
export class PostService {
   ...
   constructor( private http:HttpClient,private db:AngularFirestore){}
    ...
    //   this.db.doc('post/'+post.category).update(post);
   ...
   //send Http request it take json data the angullar convert the object into json data
    ...
    console.log(postData);//request are only send when you subscribe
   }
 ...
 updatePost(post:Post)
 {
   this.http.patch('https://chatbot-47543-default-rtdb.firebaseio.com/posts/'+post.id+'.json',post);
 }
